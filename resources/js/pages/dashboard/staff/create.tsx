                            ...
                            <form className="space-y-6" onSubmit={handleFormSubmit}>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <Input placeholder="John Doe" type='text' id='name' value={data.name} onChange={(e) => setData('name', e.target.value)} aria-invalid={!!errors.name} />
                                    ...
                                    <div>
                                        <Label>Phone</Label>
                                        <Input placeholder="+1234567890" type='tel' value={data.phone} onChange={(e) => setData('phone', e.target.value)} aria-invalid={!!errors.phone} />
                                    ...
                                    <div>
                                        <Label>Salary</Label>
                                        <Input placeholder="$50,000" type='number' value={data.salary} onChange={(e) => setData('salary', e.target.value)} aria-invalid={!!errors.salary} />
